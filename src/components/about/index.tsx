        ...
        <div id="about" className="elements">
            <div className="bio element">
                <div className="blurb">
                    ...
                    <h4 className="sub" id="el1">Building + Design</h4>
                    ...
                    <h4 className="sub" id="el2">Background</h4>
                    ...
                    <h4 className="sub" id="el3">More</h4>
                    ...
                    <Animation/>
                    {/* <div className="image"><img src="drink.png"/></div> */}
                </div>
            </div>
    )
}